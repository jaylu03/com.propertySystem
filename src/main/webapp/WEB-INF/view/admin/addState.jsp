...
<meta
	...
	name="viewport">
<title>HOUSE MART | Add State</title>
<!-- General CSS Files -->
				...
				<section class="section">
					<div class="section-body">
						<div class="row">
							<div class="col-12 ">
								<div class="card">
									<h:form action="saveState" method="post" modelAttribute="StateVO" onsubmit="return addState()">
										<h:hidden path="id"/>
										...
										<div class="card-body">
											<div class="form-group">
												<label>State Name</label> <h:input path="stateName"
													class="form-control" id="stateName" onkeypress='return event.charCode>=65 && event.charCode<=90 || event.charCode>=97 && event.charCode<=122'/>
											</div>
											<div class="form-group mb-0">
												<label>State Description</label>
												<h:textarea class="form-control" path="stateDescription" id="stateDescription"></h:textarea>
											</div>
										</div>
