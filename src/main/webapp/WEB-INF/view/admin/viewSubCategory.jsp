...
<meta
	...
	name="viewport">
<title>HOUSE MART | View SubCategory</title>
<!-- General CSS Files -->
												...
												<tbody>
													...
													<c:forEach items="${subCategoryList}" var="i" varStatus="j">
														...
														<tr>
															...
															<a href="editSubCategory?id=${i.id}"> <i class="fas fa-edit"
																style="padding-right: 15px;"
																aria-hidden="true"></i>
																</a>
																
																 <a
																href="deleteSubCategory?id=${i.id}"><i
																	class="fas fa-trash" style="color: tomato;"
																	aria-hidden="true"></i>
																	</a>
																</td>
