...
<meta
	...
	name="viewport">
<title>HOUSE MART | Add SubCategory</title>
<!-- General CSS Files -->
				...
				<section class="section">
					<div class="section-body">
						<div class="row">
							<div class="col-12">
								<div class="card">
									<h:form action="saveSubCategory" method="post" modelAttribute="subCategoryVO" onsubmit="return addSubCategory()">
									...
									<h:hidden path="id"/>
										...
										<div class="card-body">
											<div class="form-group">
												<h:select path="categoryVO.id" class="form-control" id="categoryVOId">
											...
											<div class="form-group ">
												<label>Sub Category Type</label> <h:input type="text"
													class="form-control" path="subCategoryName" id="subCategoryName" onkeypress='return event.charCode>=65 && event.charCode<=90 || event.charCode>=97 && event.charCode<=122'/>
											</div>
											<div class="form-group mb-0">
												<label>Sub Category Description</label>
												<h:textarea path="subCategoryDescription" class="form-control" id="subCategoryDescription"></h:textarea>
											</div>
										</div>
