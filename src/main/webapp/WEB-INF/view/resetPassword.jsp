                ...
                <div class="form-section align-self-center">
                   ...
                   <!--  <div class="btn-section clearfix">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group form-box">
                            <input id="confirmpassword" type="password" name="confirmpassword" class="input-text" placeholder="Confirm Password">
                        </div> 
                        <div class="form-group">
                            <button type="button" class="btn-md btn-theme float-left" onclick="compareStr()">
