        ...
        <div class="row login-box">
            <div class="col-lg-6 align-self-center pad-0">
                <div class="form-section align-self-center">
                    <div class="clearfix">OTP Page</div>
                                <div class="form-group form-box">
                                    <div class="row">
                                        <div class="col-md-12"><label for="regemail" class="control-label form-label">OTP:</label><input onkeypress="return event.charCode>=48 &amp;&amp; event.charCode<=57" id="regemail" type="email" placeholder="" class="form-control form-input"/><!--p.help-block Warning !--></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <button type="button" class="btn-md btn-theme float-left"><span>Send OTP</span></button>
                                </div>
                   ...
                   <!--  <div class="btn-section clearfix">
                    ...
                    <!-- <form method="get" action="forgotPassword"> action="j_spring_security_check"
                        <div class="form-group form-box">
                            <input type="text" name="username" class="input-text" placeholder="User Name" id="forgotpassword">
                        </div>
                        <div class="form-group form-box clearfix">
                            <input type="text" name="otp" class="input-text" placeholder="OTP" disabled="disabled">
                        </div>
                        <div class="form-group clearfix">
                            <button type="button" class="btn-md btn-theme float-left" onclick="validateEmail1()"><span>Send OTP</span></button>
