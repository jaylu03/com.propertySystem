...
<!-- <link rel="stylesheet" href="./<%=request.getContextPath()%>/adminResources/css/index.css"> -->
								...
								<div class="card-statistic-4">
									<div class="align-items-center justify-content-between">
										<div class="row ">
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
												<div class="banner-img">
													<img src="<%=request.getContextPath()%>/adminResources/image/2.png" alt="">
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card-statistic-4">
									<div class="align-items-center justify-content-between">
										<div class="row ">
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
												<div class="banner-img">
													<img src="<%=request.getContextPath()%>/adminResources/image/3.png" alt="">
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card-statistic-4">
									<div class="align-items-center justify-content-between">
										<div class="row ">
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
												<div class="banner-img">
													<img src="<%=request.getContextPath()%>/adminResources/image/4.png" alt="">
												</div>
											</div>
										</div>
									</div>
												...
												<td class="text-truncate">
													<ul class="list-unstyled order-list m-b-0 m-b-0">
														<li class="team-member team-member-sm"><img
															...
															src="<%=request.getContextPath()%>/adminResources/image/user-8.png" alt="user"
															data-toggle="tooltip" title=""
															data-original-title="Wildan Ahdian"></li>
														<li class="team-member team-member-sm"><img
															class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/img/user-9.png" alt="user"
															data-toggle="tooltip" title=""
															data-original-title="John Deo"></li>
														<li class="team-member team-member-sm"><img
															class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/image/user-10.png" alt="user"
															data-toggle="tooltip" title=""
											...
											<tr>
												...
												<td class="text-truncate">
													<ul class="list-unstyled order-list m-b-0 m-b-0">
														<li class="team-member team-member-sm"><img
															class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/img/users/user-8.png" alt="user"
															data-toggle="tooltip" title=""
															data-original-title="Wildan Ahdian"></li>
														<li class="team-member team-member-sm"><img
															class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/img/users/user-9.png" alt="user"
															data-toggle="tooltip" title=""
															data-original-title="John Deo"></li>
														<li class="team-member team-member-sm"><img
															class="rounded-circle"
						...
						<div class="col-md-6 col-lg-12 col-xl-6">
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="support-ticket media pb-1 mb-3">
										<img src="<%=request.getContextPath()%>/adminResources/image/avatar.png"
											class="user-img mr-2" alt="">
										<div class="media-body ml-3">
