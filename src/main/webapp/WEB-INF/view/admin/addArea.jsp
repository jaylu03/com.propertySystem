...
<meta
	...
	name="viewport">
<title>HOUSE MART | Add Area</title>
<!-- General CSS Files -->
				...
				<section class="section">
					<div class="section-body">
						<div class="row">
							<div class="col-12">
								<div class="card">
									<h:form action="saveArea" method="post" modelAttribute="areaVO" onsubmit="return addArea()">
									<h:hidden path="id"/>
										...
										<div class="card-body">
										 ...
										 <div class="form-group">
					                      ...
					                      <h:select path="cityVO.id" class="form-control" id="cityVOId">
											...
											<div class="form-group">
												<label>Area Name</label> <h:input type="text"
													class="form-control" path="areaName" id="areaName" onkeypress='return event.charCode>=65 && event.charCode<=90 || event.charCode>=97 && event.charCode<=122'/>
											</div>
										</div>
