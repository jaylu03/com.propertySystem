...
<meta
	...
	name="viewport">
<title>HOUSE MART | Add ConstructionStatus</title>
<!-- General CSS Files -->
				...
				<section class="section">
					<div class="section-body">
						<div class="row">
							<div class="col-12">
								<div class="card">
									<h:form action="saveConstructionStatus" method="post" modelAttribute="ConstructionStatusVO" onsubmit="return addConstructionStatus()">
									<h:hidden path="id"/>
										...
										<div class="card-body">
											<div class="form-group">
												<label>Construction Status</label> <h:input path="constructionstatusName" id="constructionstatusName" type="text"
													class="form-control" onkeypress='return event.charCode>=65 && event.charCode<=90 || event.charCode>=97 && event.charCode<=122'/>
											</div>
											<div class="form-group mb-0">
												<label>Description</label>
												<h:textarea path="constructionstatusDescription" id="constructionstatusDescription" class="form-control" ></h:textarea>
											</div>
										</div>
